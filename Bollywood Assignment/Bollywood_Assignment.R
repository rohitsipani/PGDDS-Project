...
last_10 <- rev(tail(bollywood$Movie,n=10))
last_10
...
top_2_movie <- bollywood[which(bollywood$Tcollection == max(bollywood$Tcollection[bollywood$Tcollection!=max(bollywood$Tcollection)],na.rm=TRUE)),1]
top_2_movie	  
...
movie_result <- c(bollywood[which.max(bollywood$Ocollection),1],bollywood[which.max(bollywood$Wcollection),1],bollywood[which.max(bollywood$Fwcollection),1],bollywood[which.max(bollywood$Tcollection),1])
movie_result
